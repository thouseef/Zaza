...
IMG_TEMPLATE = '<img src="%s" alt="%s" class="rating" onClick="rateMe(this)" '
ID = 'id="%s" />'
PATH_TO_WHOLE_STAR = IMG_TEMPLATE % ('/static/stars/star.png', "Whole Star")
PATH_TO_THREE_QUARTER_STAR = IMG_TEMPLATE % ('/static/stars/three-quarter.png', "3/4 Star")
PATH_TO_HALF_STAR = IMG_TEMPLATE % ('/static/stars/half.png', "1/2 Star")
PATH_TO_QUARTER_STAR = IMG_TEMPLATE % ('/static/stars/quarter.png', "1/4 Star")
PATH_TO_BLANK_STAR = IMG_TEMPLATE % ('/static/stars/blank.png', "Empty Star")
...
class ShowStarsNode(Node):
    ...
    def render(self, context):
        ...
        for blank_star in range(blanks):
            ...
            output.append(ID %(integer+blank_star+1))
